...
class Program
{
	static void Main(string[] args)
	{
		...
		str = str.Substring(str.IndexOf("object-oriented"), 15) + str.Substring(str.IndexOf(" programming"), 13) + str.Substring(str.IndexOf("in "), 3) + str.Substring(str.IndexOf("C#"), 2);
